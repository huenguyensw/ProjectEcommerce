    ...
    return (
        <div className='checkout'>
            <section className='orders'>
                <h3>Products</h3>
                <hr />
                {lineItems.length >0 ? <Cart lineItems={lineItems} totalPrice={totalPrice} handleRemoveItem={handleRemoveItem} handleResetCart={handleResetCart} handleDecrement={handleDecrement} handleIncrement={handleIncrement}/>:<h1>Shopping cart is empty</h1>}
            </section>
